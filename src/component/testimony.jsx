...
function Testimonials() {
  ...
  const cards = [
    <div className="bg-[#141414] h-[218px] md:h-[450px] w-full border border-[#404040] rounded-[24px]">
      1
    </div>,

    <div className="bg-[#141414] h-[218px] w-full border border-[#404040] rounded-[24px]">
      2
    </div>,

    <div className="bg-[#141414] h-[228px] w-full border border-[#404040] rounded-[24px]">
      3
    </div>,
...
></div>{" "}
        ...
        <div className="flex w-max animate-scroll will-change-transform">
          <div className="flex gap-x-3 shrink-0">
              ...
              <div className="bg-[#141414] lg:w-[362px] lg:h-[218px] border border-[#404040] rounded-[24px] lg:px-[16px] lg:py-[20px]">
                <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
            ...
            />
                        <div>
                            <p className="text-[white] text-[16px] font[500]">Annet Black</p>
                            <p className="text-[14px] font[400] text-[#D4D4D4]">Frontend Developer</p>
                        </div>
                    </div>
                </figure>
              </div>
              <div className="bg-[#141414] border border-[#404040] rounded-[24px] lg:w-[362px] lg:h-[196px]">
                 <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
            ...
            <div className=" lg:h-[434px] flex lg:flex-col lg:gap-2">
              <div className="bg-[#141414] border border-[#404040] rounded-[24px] lg:w-[362px] lg:h-[240px] ">
                <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
            ...
            <div className=" lg:h-[434px] flex lg:flex-col lg:gap-y-2">
              <div className="bg-[#141414] border-[#404040] rounded-[24px] lg:w-[362px] lg:h-[196px] border ">
                <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
            ...
            <div className=" lg:h-[434px] flex lg:flex-col lg:gap-y-2">
              <div className="bg-[#141414] border border-[#404040] rounded-[24px] lg:w-[362px] lg:h-[218px] ">
                 <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
            ...
            />
              ...
              <div className="bg-[#141414] border border-[#404040] rounded-[24px] lg:w-[362px] lg:h-[218px] border ">
                <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
          ...
          <div className="flex gap-x-3 shrink-0">
            <div className=" lg:flex lg:flex-col lg:gap-y-2 lg:h-[434px]">
              <div className="bg-[#141414] lg:w-[362px] lg:h-[218px] border border-[#404040] rounded-[24px]">
                 <figure className="flex flex-col gap-y-8">
                    <blockquote className="text-[14px] font-[400] leading[155%] tracking-[0.5%] text-[#D4D4D4]">
                        “Before FutureForge, I was learning design alone without structure. The mentorship and community helped me build confidence, improve my thinking, and grow faster than I expected.”
                    </blockquote>
