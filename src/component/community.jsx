...
function Community() {
    ...
    return (
        <section className="join-community flex flex-col border w-full justify-center gap-[20px] lg:gap-[32px] lg:px-0 px-3 lg:py-[0] py-10 bg-linear-to-r  from-[var(--primary-color)] to-[var(--secondary-color)] rounded-[32px] border-none">
            <div className="w-full lg:h-[470px] lg:h-[451px] flex flex-col justify-center items-center lg:gap-[16px] gap-[20px]">
                ...
                <Link to="/registration-form" className="w-full flex justify-center">
