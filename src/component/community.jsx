...
function Community() {
    ...
    return (
        <section className="join-community flex border w-full justify-center py-[60px] gap-[20px] lg:gap-[32px]  lg:mt-[120px] lg:mb-[80px] lg:px-0 px-3 bg-linear-to-r from-[var(--primary-color)] to-[var(--secondary-color)] rounded-[32px] border-none">
            <div className="w-full lg:h-[470px] lg:h-[451px] flex flex-col justify-center items-center lg:gap-[16px] gap-[20px]">
                ...
                <button className="lg:mt-3.5 flex items-center justify-center gap-[20px] text-[#000000] text-[16px] font-[700] rounded-[24px] lg:w-[239px] w-full bg-[#ffffff] lg:py-3.5 py-[18px] leading-[100%] tracking-[0.5%] cursor-pointer">Join the Next Cohort<TbArrowRight /> </button>
            </div>
        </section>
    )
}
