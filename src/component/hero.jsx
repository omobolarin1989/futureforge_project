...
function Hero() {
  return (
    <section className="hero-section grow md:flex-row lg:h-screen min-h-screen flex flex-col lg:flex-row justify-between">
      <div className="hero-text flex flex-col justify-center w-full lg:w-[40%]">
        <div className="text-content flex flex-col  lg:items-start items-center w-full">
          <div className="lg:full  lg:max-w-[40%] w-[75%] rounded-2xl p-px bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] mb-5">
            <p className="rounded-2xl bg-black px-4 py-2 text-center text-[12px]  lg:font-[700] font-[400] tracking-[1%] leading-[145%] flex justify-center grow">
