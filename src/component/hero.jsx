...
function Hero() {
  return (
    <section className="font-gadugi hero-section grow md:flex-col gap-7 md:gap-y-10 flex flex-col lg:flex-row justify-between" aria-labelledby="hero-title">
      <div className="hero-text flex flex-col justify-center w-full lg:w-[40%]">
        <div className="text-content flex flex-col  lg:items-start items-center w-full">
          <div className="lg:full  lg:max-w-[40%] w-[75%] rounded-2xl p-px bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] mb-5">
            <span className="rounded-2xl bg-black px-4 py-2 text-center   lg:font-[700] font-[400] tracking-[1%] leading-[145%] flex justify-center grow">
              <span className="font-[700] inline-block text-[12px] text-base bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] bg-clip-text text-transparent ">
          ...
          <h1 className="font-inter lg:text-[72px] text-base text-[44px] font-[700] w-full lg:w-[85%] lg:leading-[110.00000000000001%] leading-[114.99999999999999%] lg:tracking-[-2%] text-center lg:text-left tracking-[-1.5%] " id="hero-title">
            Build Your{" "}
  ...
  className="lg:w-[210px] w-full rounded-[24px] h-[50px] cursor-pointer lg:text-[16px] text-[16px] md:text-[20px] font-[700] border border-[#404040] bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] flex items-center gap-[12px] justify-center focus:outline-none 
focus:ring-1 
focus:ring-[#f68936]"
>
  Join Next Cohort 
  <CgArrowLongRight aria-hidden="true" />
</Link>

          <Link to="/cohort-story" className="flex flex-col justify-center items-center lg:w-[236px] w-full rounded-3xl h-[50px] text-[16px] lg:text-[16px] md:text-[20px] font-bold cursor-pointer border border-[#404040] hover:bg-[#171717] active:bg-[#404040] disabled:bg-[#262626] focus:outline-none 
focus:ring-1 
focus:ring-[#404040]">
      ...
      <div className="hero-image lg:w-[48%] md:w-full w-full lg:relative">
        <img
          ...
          alt="3 Students learning technology skills together"
